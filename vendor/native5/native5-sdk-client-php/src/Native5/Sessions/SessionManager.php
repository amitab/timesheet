...
/**
 * Session Manager abstracts the session lifecycle management. 
 * Can have implementations based on underlying support. 
 * 
 * @category  Sessions 
 * @package   Native5\<package>
 * @author    Barada Sahu <barry@native5.com>
...
interface SessionManager
{
     ...
     * 
     * @param mixed $context     Session context.
     ...
     * Ends active session. 
     * 
     * @param mixed $id The session id to use.
     *
     * @access public
     * @return void
     */
