$(document).ready(function(){
    ...
    $(document).hammer().on('tap', 'a#submit', function(e) {
        e.preventDefault();
        stopClock();
        setStopDate();
        resultTime();
    ...
    $(document).hammer().on('tap', '#timer-button', function(e) {
        e.preventDefault();
        if($(this).hasClass('paused')) {
            startClock();
            $(this).removeClass('paused icon-play').addClass('playing icon-pause');
        } else {
            stopClock();
            $(this).removeClass('playing icon-pause').addClass('paused icon-play');
        }
    });
