...
$(document).ready(function(){
    ...
    $(document).hammer().on('tap', 'div.more', function(e) {
    ...
    // Extra options to the footer
    var options = $('div#options').html();
    $('div#more-menu > ul').html(options);
    
    if($('#more-menu > ul').find('li').length == 0) {
