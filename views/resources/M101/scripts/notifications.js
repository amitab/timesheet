$(document).ready(function() {
    ...
    var successHandler = function(data) {
        ...
        $.each(data.message.notifications, function(key, value) {
            ...
            list += '<p class="small"><span class="from">' + value.notificationFromUser + '</span><span class="time" style="float: right;">'; 
    ...
    $(document).hammer().on('tap', 'span#sync', function(e) {
        e.preventDefault();
